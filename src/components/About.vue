      ...
      <v-card>
        <v-card-text>
          ...
          <p>
            ...
            <b>v1.2</b> Добавлена возможность выбора диапазонов диалогов, удобно для последовательной загрузки <br>
          </p>
          ...
          <p>JSON - идентично apidog'овскому формату, можно засунуть в их анализатор<br>
             HTML - отображение диалога как в ВК (только некоторые типы вложений не отбражаются, доделывать лень)<br>
